...
class Swiss3D(BaseDataset):
    """Swiss3D dataset, used in visualizer, training, or test."""
    ...
    def get_split(self, split):
        ...
        """
        return Swiss3DSplit(self, split=split)
...
class Swiss3DSplit(BaseDatasetSplit):
...
DATASET._register_module(Swiss3D)
