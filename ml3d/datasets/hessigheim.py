...
class HessigheimDataset(BaseDataset):
    def __init__(
        self,
        dataset_path,
    ...
    def get_split(self, split):
        ...
        """
        return HessigheimDatasetSplit(self, split=split, offset=self.offset)
...
DATASET._register_module(HessigheimDataset)
